...
public class UpgradePanelUI : MonoBehaviour
{
    ...
    [SerializeField] private UpgradeSectionUI _container;
    ...
    private void Start()
    {
        ...
        _container.button.onClick.AddListener(() => { UpgradeManager.instance.TryUpgradeContainerSlot(); Refresh(); });
        Refresh();
    }
    private void Refresh()
    {
        ...
        RefreshSection(_container, um.ContainerSlotCount, 2, um.ContainerSlotNextCost, um.CanUpgradeContainer());
    }
